    ...
    if not bool(cpu_count_string_var.get()): # If the CPU count variable value is empty
        ...
        try: # If the entered value can be converted into python integer
            ...
            if int(cpu_count_string_var.get()) > max_cpu: # If the CPU count variable value is larger than maximum capacity
                ...
                cpu_count_notification_string_var.set("CaRAS ready for action!") # Notify the user
...
caras_logo = tk.Label(opening_frame, image = photo, anchor = "center")
caras_logo.image = photo
caras_logo.grid(row = 2, column = 1, padx = 10, pady = 10, columnspan = 2)

# Write few sentences about CaRAS below the logo
caras_about = tk.Text(opening_frame, width = 70, height = 7, relief = tk.FLAT, bg = 'gray85',font = (None, 15))
...
caras_about.grid(row = 3, column = 1, columnspan = 2, sticky = "we", padx = 10, pady = (5,10))
...
fastqc1_arg_label = tk.Label(setting_value_frame, text = '^ fastqc1', width = 25, pady = 5, anchor = 'e')
clumpify_arg_label = tk.Label(setting_value_frame, text = '^ clumpify', width = 25, pady = 5, anchor = 'e')
bbduk_arg_label = tk.Label(setting_value_frame, text = '^ bbduk', width = 25, pady = 5, anchor = 'e')
trimmomatic_arg_label = tk.Label(setting_value_frame, text = '^ trimmomatic', width = 25, pady = 5, anchor = 'e')
fastqc2_arg_label = tk.Label(setting_value_frame, text = '^ fastqc2', width = 25, pady = 5, anchor = 'e')
bwa_mem_arg_label = tk.Label(setting_value_frame, text = '^ bwa_mem', width = 25, pady = 5, anchor = 'e')
samtools_view_arg_label = tk.Label(setting_value_frame, text = '^ samtools_view', width = 25, pady = 5, anchor = 'e')
reads_normalizer_arg_label = tk.Label(setting_value_frame, text = '^ * reads_normalizer', width = 25, pady = 5, anchor = 'e')
plotfingerprint_arg_label = tk.Label(setting_value_frame, text = 'plotfingerprint', width = 25, pady = 5, anchor = 'e')
fastqc3_arg_label = tk.Label(setting_value_frame, text = 'fastqc3', width = 25, pady = 5, anchor = 'e')
macs2_callpeak_arg_label = tk.Label(setting_value_frame, text = 'macs2_callpeak', width = 25, pady = 5, anchor = 'e')
gem_arg_label = tk.Label(setting_value_frame, text = 'gem', width = 25, pady = 5, anchor = 'e')
homer_findPeaks_arg_label = tk.Label(setting_value_frame, text = 'homer_findPeaks', width = 25, pady = 5, anchor = 'e')
genrich_arg_label = tk.Label(setting_value_frame, text = 'genrich', width = 25, pady = 5, anchor = 'e')
seacr_arg_label = tk.Label(setting_value_frame, text = 'seacr', width = 25, pady = 5, anchor = 'e')
sicer2_arg_label = tk.Label(setting_value_frame, text = 'sicer2', width = 25, pady = 5, anchor = 'e')
homer_mergePeaks_arg_label = tk.Label(setting_value_frame, text = 'homer_mergePeaks', width = 25, pady = 5, anchor = 'e')
homer_annotatePeaks_arg_label = tk.Label(setting_value_frame, text = 'homer_annotatePeaks', width = 25, pady = 5, anchor = 'e')
fold_change_calculator_arg_label = tk.Label(setting_value_frame, text = 'fold_change_calculator', width = 25, pady = 5, anchor = 'e')
peak_feature_extractor_arg_label = tk.Label(setting_value_frame, text = '** peak_feature_extractor', width = 25, pady = 5, anchor = 'e')
homer_findMotifsGenome_label = tk.Label(setting_value_frame, text = 'homer_findMotifsGenome', width = 25, pady = 5, anchor = 'e')
meme_chip_label = tk.Label(setting_value_frame, text = 'meme_chip', width = 25, pady = 5, anchor = 'e')
...
reads_normalizer_arg_label.grid(row = 8, column = 1, padx = 5)
plotfingerprint_arg_label.grid(row = 9, column = 1, padx = 5)
fastqc3_arg_label.grid(row = 10, column = 1, padx = 5)
macs2_callpeak_arg_label.grid(row = 11, column = 1, padx = 5)
gem_arg_label.grid(row = 12, column = 1, padx = 5)
homer_findPeaks_arg_label.grid(row = 13, column = 1, padx = 5)
genrich_arg_label.grid(row = 14, column = 1, padx = 5)
seacr_arg_label.grid(row = 15, column = 1, padx = 5)
sicer2_arg_label.grid(row = 16, column = 1, padx = 5)
homer_mergePeaks_arg_label.grid(row = 17, column = 1, padx = 5)
homer_annotatePeaks_arg_label.grid(row = 18, column = 1, padx = 5)
fold_change_calculator_arg_label.grid(row = 19, column = 1, padx = 5)
peak_feature_extractor_arg_label.grid(row = 20, column = 1, padx = 5)
homer_findMotifsGenome_label.grid(row = 21, column = 1, padx = 5)
meme_chip_label.grid(row = 22, column = 1, padx = 5)
...
reads_normalizer_arg_entry = tk.Entry(setting_value_frame, textvariable = reads_normalizer_arg, width = 50, justify = tk.LEFT)
...
seacr_arg_entry = tk.Entry(setting_value_frame, textvariable = seacr_arg, width = 50, justify = tk.LEFT)
...
peak_feature_extractor_arg_entry = tk.Entry(setting_value_frame, textvariable = peak_feature_extractor_arg, width = 50, justify = tk.LEFT)
...
reads_normalizer_arg_entry.grid(row = 8, column = 2, padx = 5, ipady = 3)
plotfingerprint_arg_entry.grid(row = 9, column = 2, padx = 5, ipady = 3)
fastqc3_arg_entry.grid(row = 10, column = 2, padx = 5, ipady = 3)
macs2_callpeak_arg_entry.grid(row = 11, column = 2, padx = 5, ipady = 3)
gem_arg_entry.grid(row = 12, column = 2, padx = 5, ipady = 3)
homer_findPeaks_arg_entry.grid(row = 13, column = 2, padx = 5, ipady = 3)
genrich_arg_entry.grid(row = 14, column = 2, padx = 5, ipady = 3)
seacr_arg_entry.grid(row = 15, column = 2, padx = 5, ipady = 3)
sicer2_arg_entry.grid(row = 16, column = 2, padx = 5, ipady = 3)
homer_mergePeaks_arg_entry.grid(row = 17, column = 2, padx = 5, ipady = 3)
homer_annotatePeaks_arg_entry.grid(row = 18, column = 2, padx = 5, ipady = 3)
fold_change_calculator_arg_entry.grid(row = 19, column = 2, padx = 5, ipady = 3)
peak_feature_extractor_arg_entry.grid(row = 20, column = 2, padx = 5, ipady = 3)
homer_findMotifsGenome_arg_entry.grid(row = 21, column = 2, padx = 5, ipady = 3)
meme_chip_arg_entry.grid(row = 22, column = 2, padx = 5, ipady = 3)

start_from_bam_disclaimer_label = tk.Label(setting_value_frame, text = ' ^ Will be ignored if input files are aligned reads (.bam)', width = 70, padx = 10, anchor = "w")
reads_normalizer_disclaimer_label = tk.Label(setting_value_frame, text = ' * Will be ignored if aligned reads are not to be normalized', width = 70, padx = 10, anchor = "w")
peak_feature_extractor_disclaimer_label = tk.Label(setting_value_frame, text = '** Will be ignored in bulk analysis mode', width = 70, padx = 10, anchor = "w")

start_from_bam_disclaimer_label.grid(sticky = "we", row = 23, column = 1, padx = 10, columnspan = 2, pady = (5,0))
reads_normalizer_disclaimer_label.grid(sticky = "we", row = 24, column = 1, padx = 10, columnspan = 2)
peak_feature_extractor_disclaimer_label.grid(sticky = "we", row = 25, column = 1, padx = 10, columnspan = 2)

# Clickable button that triggers a function when activated
default_setting_button = tk.Button(setting_value_frame, text = "Restore defaults", command = lambda : setting_table_entry_popup_function('no'), width = 25)
CreateToolTip(default_setting_button, text = 'Click here if you want to restore\nto CaRAS pipeline default settings')
default_setting_button.grid(sticky = "w", row = 30, column = 1, padx = (10,5), pady = 10)

# Create navigation buttons
setting_value_accept_button = tk.Button(setting_value_frame, text = "Accept and close", command = lambda : change_frame_function(setting_value_frame, setting_table_frame), width = 25)
setting_value_accept_button.grid(sticky = "e", row = 30, column = 2, padx = (5,10), pady = 10)
